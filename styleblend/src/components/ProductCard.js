...
const ProductCard = ({ product }) => {
  return (
    <div>
      <div className="w-[262px] h-fit flex-col justify-center items-start gap-3 inline-flex">
        {/* top section */}
        <div className="w-[262px] h-[349px] relative flex-col justify-start items-start flex group">
          {/* image */}
          <div className="w-[262px] h-[349px] flex-col justify-center items-center inline-flex">
            <img className="w-[262px] h-[349px] object-cover" src={product.Image} alt={product.name} />
          </div>
          {/* Like */}
